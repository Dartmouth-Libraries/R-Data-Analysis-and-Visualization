...
1.  Go to [dartgo.org/r-data-viz](https://dartgo.org/r-data-viz). Follow link to download zipped drive.
    1.  alternate option: Visit our repository to download code for this course: <https://github.com/Dartmouth-Libraries/R-Data-Analysis-and-Visualization>.
    2.  Select the green `Code` button –\> `Download Zip`.
2.  Unzip the folder and place it in your Downloads folder on your local drive (or cloud drive if you prefer).

## 5. Coding in R (from the console)
...
3.  We can store values (numbers, strings, lists, and far more complicated data types) in variables.

4.  In the console the right assign your favorite number to a variable like this:
