...
-   **data visualization**: "display of data designed to analysis, exploration, and discovery."
...
![The Yü Chi Thu Map (China, 11th century A.D.): an example of a sophisticated geographic map centuries before the creation of the first "data" or "statistical maps".](images/Tufte_21_Chinese-map_cropped.png){alt="The Yü Chi Thu Map (China, 11th century A.D.): an example of a sophisticated geographic map centuries before the creation of the first \"data\" or \"statistical maps\"."}
