...
\`\`\`{r} omitb \<- tribble(\~name, \~occupation, \~apartment, \~is_suspect, \~is_dead, "Charles", "washed-up actor", "14C", "no", "no",} "Mabel", "unemployed never-was", "12E", "maybe", "no", "Oliver", "theater director", "10D", "no", "no", "Howard", "childless cat guy", "3D", "yes", "no", "Bunny", "petty despot", "12A", "no", "maybe" )
